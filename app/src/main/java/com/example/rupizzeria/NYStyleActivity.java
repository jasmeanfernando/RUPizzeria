...
/**
 * NYStyleActivity: Activity that controls activity_ny_style.xml.
...
public class NYStyleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lambda expression that initializes the making of a NY pizza > placePizza (placePizzaButton)
        placePizza.setOnClickListener(view -> {
            ...
            MainActivity.orderOfNewYorkPizzas.add(flavoredPizza);
        ...
        backToMain.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(NYStyleActivity.this, MainActivity.class);
    ...
    private void clearActivity() {
        ...
        //returns to NYStyleActivity
        Intent intent = new Intent(NYStyleActivity.this, NYStyleActivity.class);
        startActivity(intent);
    }
}